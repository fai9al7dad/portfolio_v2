      ...
      <div className="container mx-auto w-8/12 flex flex-row-reverse justify-between items-center">
        <div className="flex items-center">
          ...
          <div className=" bg-gradient-to-r from-sky-500 to-sky-600  border-2 border-sky-300 rounded px-3 py-1 ml-5  flex justify-between items-center">
            <Link to="/en/contact" className="text-lg text-white ">
              Contact me
            </Link>
          </div>
          <Link
            to={langPath}
            replace
            className="bg-gray-700 hover:bg-gray-600 border-2 border-gray-600 cursor-pointer rounded px-2 py-1 ml-5 flex justify-between items-center "
          >
            <svg
        ...
        <div>
          <Link to="/en" className="font-bold text-lg text-accent">
            Faisal Haddad
          </Link>
        </div>
      </div>
