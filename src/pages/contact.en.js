        ...
        <LayoutEN>
            <div className="h-screen flex items-center justify-center px-5">
                <div class='grid md:grid-cols-2 gap-10'>
                    <div class='md:grid md:grid-cols-2 gap-5 order-2'>
                        ...
                        <a href='https://wa.me/966599924457' target='_blank' class='bg-gradient-to-r from-sky-300 to-sky-400 hover:from-blue-400 transation duration-300  shadow-xl col-span-3  px-10 py-5  my-5 lg:my-0  rounded-lg flex items-center justify-center'>
                    ...
                    <div class='flex flex-col items-start'>
                        ...
                        <div class='text-lg md:text-3xl text-left font-bold text-gray-'>
                            We're honored!..
                        </div>
                        <div class='text-lg md:text-3xl text-left text-gray-500 mt-5'>
                            Contact me so You can the take the first step of achieving it!
                        </div>
                        <div class='text-sm md:text-sm text-left text-gray-400 mt-5'>
                            press the channel that suits you, and you will get redirected immeditiley into a conversation with me !
                        </div>
                    </div>
                </div>
            </div>
