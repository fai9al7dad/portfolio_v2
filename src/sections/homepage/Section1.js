            ...
            <div className="flex flex-col items-center justify-center z-20">
                ...
                <div className="grid md:grid-cols-2 w-full md:w-max">
                    <div className="w-full mb-5">
                        <Link to ="/projects" className="hover:bg-gray-600 bg-gray-700 border-2 border-gray-600 rounded-lg px-5 mr-0 md:mr-5 py-1 flex justify-center items-center">
                            <div className='text-lg font-bold py-2 px-5 text-white '>مشاريعي</div>
                            <div className="text-lg">🛠️</div>
                        </Link>
                    </div>
                    <div className="w-full">
                        <Link to ="/contact" className=" bg-gradient-to-r  from-sky-500 to-sky-600  border-2 border-sky-300 rounded-lg px-3 py-1 flex justify-center items-center">
