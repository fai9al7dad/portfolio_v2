        ...
        <div className="grid md:grid-cols-2 gap-10">
          <div className="md:order-2 flex flex-col items-end">
            ...
            <div className="">
              <div className="text-lg tracking-wide leading-relaxed lg:text-2xl mt-5 text-gray-500 z-10 md:py-5">
                {" "}
                بعد الانتهاء من مرحلة البحث أبدا اصمم تصميمًا{" "}
                <span className="text-white">
                  يركز أولا على وصول المستخدم للغاية التي يريدها العميل بأسهل
                  طريقة ممكنة
                </span>
              </div>
            </div>
          ...
          <div className="flex flex-col items-center justify-center relative">
            ...
            <div className="flex flex-col items-center z-20">
              ...
              />
              <div className="text-xs font-normal text-accent mt-2 z-10">
                ADOBE XD صورة أثناء تصميم الموقع عن طريق برنامج
              </div>
            </div>
          </div>
        </div>
