      ...
      <div className="text-right container mx-auto  flex flex-col items-end justify-center h-screen">
        <div className="grid md:grid-cols-2 gap-10">
          <div className="flex flex-col items-end">
            ...
            <div className="text-sm font-bold text-white mt-2">Development</div>
            ...
            <div className="md:w-3/4">
              <div className="">
                <div className="text-lg tracking-wide leading-relaxed lg:text-2xl mt-5 text-gray-500 z-10 md:py-5">
                  أطول مرحلة، بعد الإنتهاء من البحث والتصميم ، ومع هيكلة واضحة
                  للنظام، أستطيع البرمجة بكل أريحية مع وضع السرعة والتوسع في
                  الحسبان{" "}
