      ...
      <div className="flex flex-col items-center justify-center z-20">
        ...
        <div className="grid md:grid-cols-2 w-full md:w-max">
          <div className="w-full">
            <Link
              to="/en/contact"
              className=" bg-gradient-to-r  from-sky-500 to-sky-600  border-2 border-sky-300 rounded-lg mr-0 md:mr-5 px-3 py-1 flex justify-center items-center"
            >
          ...
          <div className="w-full mt-5 md:mt-0">
            <a
              ...
              target="_blank"
              className="hover:bg-gray-600 bg-gray-700 border-2 border-gray-600 rounded-lg px-5  py-1 flex justify-center items-center"
            >
              <div className="text-lg font-bold py-2 px-5 text-white ">
                Resume
              </div>
