      ...
      <div className="text-right container mx-auto px-5 md:px-0  flex flex-col items-end justify-center h-screen ">
        <div className="grid md:grid-cols-2 gap-10">
          <div className="flex flex-col items-start">
            ...
            <div className="text-sm font-bold text-white mt-2">UI/UX</div>
            <div className="text-3xl tracking-wide text-white leading-relaxed lg:text-3xl mt-3 text-left">
            ...
            <div className="">
              <div className="text-lg tracking-wide text-left leading-relaxed lg:text-2xl mt-5 text-gray-500 z-10 md:py-5">
                ...
                <span className="text-white ml-2">
                  that focuses on making the user achieve the client goal in the
          ...
          <div className="flex flex-col items-center justify-center relative">
            ...
            <div className="flex flex-col items-center z-20">
              <img
                src={adobexdDesign}
                className="mt-5 rounded-2xl z-10 w-full "
              />
              <div className="text-sm font-normal text-accent mt-2 z-10">
                A screenshot while designing the website on ADOBE XD
              </div>
            </div>
          </div>
        </div>
